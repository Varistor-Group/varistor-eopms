...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Mobile Drawer Shell */}
      <aside className={`fixed inset-y-0 left-0 bg-varistor-surface w-64 max-w-xs flex flex-col z-50 transform transition-transform duration-200 lg:hidden ${isOpenMobile ? 'translate-x-0' : '-translate-x-full'
        }`}>
