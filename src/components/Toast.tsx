...
export const Toast: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-3 left-3 sm:left-auto sm:right-6 z-50 flex flex-col gap-3 max-w-[calc(100vw-1.5rem)] sm:max-w-sm w-full pointer-events-none">
      {toasts.map((toast) => {
